...
var isAdmin = function isAdmin() {
  var adminEmails = ['admin@srubin.org'];
  var inAdminList = false;
...
var onAdminGetAllPages = function onAdminGetAllPages(event) {
  event.preventDefault();
  api.getPages().then(ui.adminGetAllPagesSuccess).catch(ui.getMyPagesFailure);
};
...
var adminGetAllPagesSuccess = function adminGetAllPagesSuccess(data) {
  var getMyPagesHTML = showMyPagesTemplate({ pages: data.pages });
  $('.page-content').html(getMyPagesHTML);
  if (data.pages.length === 0) {
    $('.page-content').html('<h2>No pages were found</h2>');
  }
...
module.exports = {
  ...
  adminGetAllPagesSuccess: adminGetAllPagesSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onAdminGetAllBlogs = function onAdminGetAllBlogs(event) {
  event.preventDefault();
  api.getBlogs().then(ui.adminGetAllBlogsSuccess).catch(ui.getMyBlogsFailure);
};
...
var adminGetAllBlogsSuccess = function adminGetAllBlogsSuccess(data) {
  var getMyBlogsHTML = showMyBlogsTemplate({ blogs: data.blogs });
  $('.blog-content').html(getMyBlogsHTML);
  if (data.blogs.length === 0) {
...
module.exports = {
  ...
  adminGetAllBlogsSuccess: adminGetAllBlogsSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
